...
/**
 * bst_checker - this checks if a binary tree is a binary search tree.
 * @tree: binary tree!
 * @min: minimum value of the tree!
...
/**
 * tree_height_1 - calculates the height of a binary tree.
 * @tree: binary tree!!!
 * @n: accumulated height of the current tree!!!
...
/**
 * avl_tree_balance - this function recursively checks
 * the balance of a binary tree and its nodes and sets
 * the balanced flag to 0 if it isn't all balanced.
 * @tree: binary tree!
...
/**
 * binary_tree_is_avl - this checks if the given tree
 * is an AVL tree.
