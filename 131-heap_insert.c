...
/**
 * enqueue_item_3 - this function adds an item to a queue
...
/**
 * dequeue_item_3 - this function removes an item from a queue.
...
/**
 * get_insert_position - this function gets the next
 * available insertion position \
 * for a node in a max binary heap tree.
 * @root: root of the max binary heap tree
 *
 * Return: The insertion position, Or NULL.
 */
...
/**
 * swap_tree_node_with_parent - this function Swaps a node
 * in a
...
/**
 * heap_insert - this function inserts a value into a max
 * binary heap tree.
 * @root: A pointer to the root of the tree
