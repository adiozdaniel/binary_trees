...
/**
 * binary_search_tree_checker - this checks if a binary tree
 *
 * @tree: The binary tree!!!
 * @min: The minimum value of the tree!!!
 * @max: The maximum value of the tree!!!
...
/**
 * binary_tree_is_bst - this checks if a binary tree is binary search tree.
 * @tree: binary tree!
 *
 * Return: 1 if the binary tree is binary search tee, otherwise 0.
 */
