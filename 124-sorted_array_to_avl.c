...
/**
 * tree_builder - this function builds an AVL tree from a sorted array
 * @parent: AVL tree's parent!
 * @array: sorted array of integers!
 * @size: length of the given array!
 *
 * Return: A pointer to the root of the AVL tree, OR NULL.
 */
...
/**
 * sorted_array_to_avl - function builds an AVL tree from a sorted array.
 * @array: sorted array of integers
 * @size: length of the given array
 *
 * Return: A pointer to the root of the AVL tree, OR NULL.
