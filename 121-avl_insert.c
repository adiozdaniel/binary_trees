...
/**
 * bst_insert_helper - this inserts a node into a binary search tree.
...
/**
 * tree_height_2 - calculates the height of a binary tree.
 * @tree: binary tree!
 *
...
/**
 * adjust_balance - this function adjusts
 * the balance of an AVL tree by
